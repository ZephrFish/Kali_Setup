...
# Checking for Internet and Root
rootcheck
checkinternet

#Updating OS
echo "ZephrFish Kali Setup Script "
...
# Install Terminator
pause "Press Enter to Install Terminator"
...
# I plan on replacing this with eyewiness and https://github.com/ZephrFish/Autopeeper when I have the script fully built
